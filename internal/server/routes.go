...
func (a *App) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.Handle("GET /retros/{id}/invite-link", auth.RequireAdmin(handlers.HandleRetrosInvite(a.DB, r, a.Cfg.Port, a.Cfg.GetIP)))
	...
	mux.HandleFunc("GET /join/{token}", handlers.HandleRetrosJoin(a.DB))
